  ...
  function ( dgCh_cat )
    ...
    AddIdentityMorphism( dgCh_cat,
      function ( dgCh_cat, C )
        ...
        return DgCochainComplexMorphism( C, C, 0, AsZFunction( i -> IdentityMorphism( UnderlyingCategory( dgCh_cat ), C[i] ) ) );
    ...
    AddPreCompose( dgCh_cat,
      function ( dgCh_cat, phi, psi )
        ...
        return DgCochainComplexMorphism(
                    Source( phi ),
                    Range( psi ),
                    DegreeOfDgComplexMorphism( phi ) + DegreeOfDgComplexMorphism( psi ),
